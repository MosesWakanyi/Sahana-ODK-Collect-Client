...
//            String url = settings.getString(PreferencesActivity.KEY_SERVER_URL,getString(R.string.default_server_url)) + "/submission";
//            
//            mInstanceUploaderTask.setUploadServer(url);
//            mInstanceUploaderTask.setLogon(settings.getString(PreferencesActivity.KEY_USERNAME, "").trim());
//            mInstanceUploaderTask.setPassword(settings.getString(PreferencesActivity.KEY_PASSWORD, "").trim());
//
...
//    
        ...
        switch (id) {
            ...
            case AUTH_DIALOG:
                ...
                if (server == null) {
                    ...
                    server =
                    		getSettingsFromPreferences().getString(PreferencesActivity.KEY_SERVER_URL,
                            getString(R.string.default_server_url))
                                + getSettingsFromPreferences().getString(PreferencesActivity.KEY_FORMLIST_URL,
                                    "/formList");
                }
                ...
                String storedUsername = getSettingsFromPreferences().getString(PreferencesActivity.KEY_USERNAME, null);
                username.setText(storedUsername);

                EditText password = (EditText) dialogView.findViewById(R.id.password_edit);
                String storedPassword = getSettingsFromPreferences().getString(PreferencesActivity.KEY_PASSWORD, null);
                ...
                b.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Long[] toSendArray = new Long[mInstancesToSend.size()];
                        mInstancesToSend.toArray(toSendArray);
                     //   mInstanceUploaderTask.setLogon(settings.getString(PreferencesActivity.KEY_USERNAME, ""));
                     //   mInstanceUploaderTask.setPassword(settings.getString(PreferencesActivity.KEY_PASSWORD, ""));
                        mInstanceUploaderTask.execute(toSendArray);
                        showDialog(PROGRESS_DIALOG);
                    }
                });
    ...
    private SharedPreferences getSettingsFromPreferences(){
    	if (settings == null) {
