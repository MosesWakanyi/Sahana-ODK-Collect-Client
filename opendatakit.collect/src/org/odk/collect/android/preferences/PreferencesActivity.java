...
public class PreferencesActivity extends PreferenceActivity implements
    ...
    private void updateUsername() {
        ...
        String s = mUsernamePreference.getText();
        mUsernamePreference.setText(s);
        mUsernamePreference.setSummary(s);
    ...
    private void updatePassword() {
        ...
        if (mPasswordPreference.getText() != null && mPasswordPreference.getText().length() > 0) {
        	String s = mPasswordPreference.getText();
        	mPasswordPreference.setText(s);
            mPasswordPreference.setSummary(s);
        } else {
